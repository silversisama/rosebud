...
const u16 gMetatiles_VelvetRoom[] = INCBIN_U16("data/tilesets/primary/velvet_room/metatiles.bin");
const u16 gMetatileAttributes_VelvetRoom[] = INCBIN_U16("data/tilesets/primary/velvet_room/metatile_attributes.bin");
