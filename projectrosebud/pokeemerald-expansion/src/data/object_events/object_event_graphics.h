...
const u32 gObjectEventPic_Zorua[] = INCBIN_U32("graphics/object_events/pics/pokemon_old/zorua.4bpp");
const u16 gObjectEventPalette_Zorua[] = INCBIN_U16("graphics/object_events/pics/pokemon_old/zorua.gbapal");
